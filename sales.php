...
function bind_change(){
	...
	function get_sales(batch_id){
		$.getJSON('sales_action.php',{action:'get_sales',batch_id:batch_id,r:Math.random()},
			function(data){			
				...
				$.getJSON('sales_action.php',{action:'get_sales_detail',batch_id:batch_id,r:Math.random()},
						function(data){
	...
	$.get('sales_action.php?action=show_detail',{r:Math.random(),batch_id:batch_id},function(data){
